...
class DPOUTR5SpeciesSpecificJointSequenceSequenceDataset(Dataset):
    def __init__(
        ...
        self.keys = self.data['refseq_id'].tolist()
...
class DPOUTR5SpeciesSpecificJointSequenceDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):      
        ...
        if stage == "fit" or stage == "validate" or stage is None:
            # preference dataset
            self.training_dataset = DPOUTR5SpeciesSpecificJointSequenceSequenceDataset(self.preference_data_path, self.metadata_path, mode='train')
            self.validation_dataset = DPOUTR5SpeciesSpecificJointSequenceSequenceDataset(self.preference_data_path, self.metadata_path, mode='val')
        ...
        if stage == "test":
            self.test_dataset = DPOUTR5SpeciesSpecificJointSequenceSequenceDataset(self.preference_data_path, self.metadata_path, mode='test')
